...
You should not commit this directory to version control. More broadly, generated files under
`.netlify/` (including `edge-runtime/`, manifests, deploy blobs, and other build outputs) should
also be excluded from version control unless there is a documented exception.
