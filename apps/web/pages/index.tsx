          ...
          <div className="container god-hero-inner">
            <div className="god-hero-copy">
              ...
              <p className="hero-copy">
                Infæmous Freight Enterprise delivers an operator-first command center for
                revenue-grade logistics control. Enterprise-ready, AI-powered, battle-tested.
              </p>
          ...
          <div className="container">
            <div className="command-header">
              <div>
                ...
                <p className="section-subtitle">Space to think. Space to win. Space to control.</p>
              </div>
              <CrimsonOracle />
            </div>
          ...
          <div className="container callout">
            ...
            <div className="dashboard-grid" style={{ marginTop: "24px" }}>
              ...
              <div className="spark-panel">
                ...
                <p className="hero-copy">
                  Long-press command mode, haptic confirmations, and red energy swipe actions
                  deliver the mobile god interface.
                </p>
                <div className="hero-actions">
 ...
 * - Reduced server load
 * - Better SEO (faster LCP, improved Core Web Vitals)
 * - Fresh content hourly without full rebuilds
 *
 * On-demand revalidation available via:
 * POST /api/revalidate?secret=<REVALIDATE_SECRET>&path=/
 */
export async function getStaticProps() {
  // You can fetch dynamic data here in the future
  // For now, returning static data
  return {
    props: {
      // You could add real-time data here:
      // - featuredShipments
      // - liveMetrics
