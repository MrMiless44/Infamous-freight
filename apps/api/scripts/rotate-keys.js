...
function rotateJWTSecret(gracePeriodDays = 7) {
  ...
  console.log(
    `4. After ${gracePeriodDays} days (${gracePeriodEnd.toLocaleDateString()}), remove JWT_SECRET_OLD`,
  );
  ...
  console.log("\nFly.io deployment:");
  console.log(
    `  flyctl secrets set JWT_SECRET="${newSecret.secret}" --app infamous-freight-as-3gw`,
  );
