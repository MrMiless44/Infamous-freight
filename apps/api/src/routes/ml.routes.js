...
router.get(
    ...
    [
        query("corridor")
            .isString()
            .withMessage("Corridor required (e.g., Denver→Phoenix)"),
            ...
            res.status(200).json({
                ...
                data: {
                    ...
                    pricing: {
                        ...
                        conversionPredictions: optimization.conversionPredictions.filter(
                            (p, i) => i % 2 === 0
                        ), // Show every other option
