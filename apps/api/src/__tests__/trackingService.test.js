...
describe("TrackingService - Current Location", () => {
  ...
  test("should get current location for entity", async () => {
    ...
    const result = await trackingService.getCurrentLocation("vehicle", "vehicle_123");
  ...
  test("should return null for entity with no location data", async () => {
    ...
    const result = await trackingService.getCurrentLocation("vehicle", "nonexistent");
...
describe("TrackingService - Geofencing", () => {
  ...
  test("should detect point inside circular geofence", async () => {
    ...
    const inside = trackingService.isPointInGeofence(40.7173, -74.006, geofence);
    expect(inside).toBe(true);

    // Point 2km away (outside)
    const outside = trackingService.isPointInGeofence(40.7308, -74.006, geofence);
...
describe("TrackingService - Alerts", () => {
  ...
  test("should acknowledge alert", async () => {
    ...
    const result = await trackingService.acknowledgeAlert("alert_1", "user_123");
...
describe("TrackingService - Distance Calculations", () => {
  test("should calculate distance between two points correctly", () => {
    ...
    const distance =
      require("../services/trackingService").__proto__.constructor.prototype.constructor
        .calculateDistance ||
