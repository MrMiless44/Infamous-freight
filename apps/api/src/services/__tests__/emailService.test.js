...
describe("Email Service", () => {
  ...
  describe("sendShipmentNotification", () => {
    test("sends shipment created notification", async () => {
      ...
      await emailService.sendShipmentNotification(shipment, "customer@example.com", "created");
    ...
    test("includes tracking link in notification", async () => {
      ...
      await emailService.sendShipmentNotification(shipment, "customer@example.com", "updated");
  ...
  describe("sendBatch", () => {
    ...
    test("handles batch send failure", async () => {
      ...
      const emails = [{ to: "user1@example.com", subject: "Subject", text: "Text" }];
