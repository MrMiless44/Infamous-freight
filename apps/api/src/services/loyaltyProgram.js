        ...
        progress: {
          ...
          spend: {
            ...
            percentComplete: Math.min(
              100,
              Math.round((totalSpend / upgradePath.spendNeeded) * 100),
            ),
          },
          shipments: {
            ...
            percentComplete: Math.min(
              100,
              Math.round((shipmentCount / upgradePath.shipmentsNeeded) * 100),
            ),
          },
        },
  ...
  _generateRecommendations(tier, inactiveDays, pointsBalance) {
    ...
    if (inactiveDays > 60) {
      recommendations.push({
        type: "activity",
        message:
          "You have not shipped in 60+ days. Welcome back with 50 bonus points on your next shipment!",
        bonus: 50,
      });
    }
