 ...
 * }
 */
router.post("/", authenticate, requireScope("webhooks:write"), (req: Request, res: Response) => {
 ...
 * GET /api/webhooks
 */
router.get("/", authenticate, requireScope("webhooks:read"), (req: Request, res: Response) => {
