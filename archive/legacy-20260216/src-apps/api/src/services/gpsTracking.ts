...
class GPSTrackingManager {
   ...
   */
  calculateETA(driverId: string, destination: { lat: number; lng: number }): ETACalculation | null {
   ...
   */
  getLocationHistory(driverId: string, loadId: string): LocationHistory | undefined {
