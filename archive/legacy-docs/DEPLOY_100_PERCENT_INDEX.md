...
| **Metrics**        | `curl /api/metrics`  | Prometheus format with http*request*\* |
...
**See [DEPLOY_NOW_CHECKLIST.md](DEPLOY_NOW_CHECKLIST.md) for detailed
troubleshooting**
...
6. Monitor → Check
   [DEPLOYMENT_STATUS_100_PERCENT.md](DEPLOYMENT_STATUS_100_PERCENT.md#monitoring-setup-post-deploy)
