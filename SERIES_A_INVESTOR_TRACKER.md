# SERIES A INVESTOR TRACKING & OUTREACH PLAN

## SERIES A FUNDRAISING SETUP - FEBRUARY 2026

**Target raise**: $1.5M  
**Timeline**: Month 1-3 (close by Month 4 ideally)  
**Fundraising lead**: Santorio Miles (CEO/Founder)  
**Support**: [CFO name] + [Advisor name]
...
Happy to grab coffee if you want to learn more first.

Thanks,
Santorio
```

### WEEK 2: Initial Meetings (Feb 20-26)
...
- Deck: SERIES_A_INVESTOR_DECK_2026.md (PDF)
...
4. Unit economics: 10-15x LTV:CAC (exceptional)
...
### WEEK 3: Diligence Phase (Feb 27-Mar 5)
...
- [ ] Cap table history (shows previous rounds)
- [ ] SAFE agreements (if previous fundraising)
- [ ] IP documentation (all code is owned)
- [ ] Team bios + LinkedIn profiles
- [ ] Pitch deck + supporting materials
- [ ] Monthly metrics (Jan-Feb actuals)
- [ ] Customer references (3-5 willing to chat)

**Request for data room access**: Indicate investor interest level

```
VC interest levels:
🟢 HIGH: Requesting data room, asking technical questions
🟡 MEDIUM: Interested but want to learn more (coffee round 2)
🔴 LOW: "Let's stay in touch" (pass for now)
```

### WEEK 4: Term Sheet Negotiations (Mar 6-12)
...
- Anti-dilution: Broad-based (standard for early founders)
- Liquidation preference: 1x non-participating (founder-friendly)

**Timeline**: 2-week negotiation typical

---

## 🎯 GOOGLE VENTURES (GV) STRATEGY
...
5. **Google Synergies**:
   - Google Maps API integration potential
   - Google Cloud infrastructure customer
   - Google Workspace integration opportunities
   - AI/ML powered by Google technology

### GV Outreach Strategy
...
• Launched 2 weeks ago → $8.2M ARR
• 30% Free→Pro conversion (product-led growth)
• 10-15x LTV:CAC (top 1% of SaaS)
• AI-native (Genesis AI = Copilot for freight)

Why this matters to GV:
1. We're built on Google Cloud (infrastructure customer)
2. Integration opportunities with Google Maps, Workspace
3. AI/ML is our core differentiator (GV's investment thesis)
4. Logistics market GV knows well (Convoy, Uber, Flexport)
5. Exceptional metrics at early stage (rare)

The opportunity:
• $900B freight TAM
• 4.2M owner-operators (untapped market)
...
### CapitalG (Google Growth) Strategy
...
4. Brand credibility (Google-backed = enterprise trust)

---

## INVESTOR TARGETING BY PROFILE
...
Track warm intro requests + status:

```
[ADVISOR NAME]         → [VC PARTNER]       Status: [OUTREACH/INTRO SENT/MEETING SCHEDULED]
Santorio's old boss    → Sapphire Ventures  Status: WARM INTRO SENT (2/15)
Advisor #1             → Sequoia Capital    Status: WAITING FOR CALLBACK
Advisor #2             → Insight Partners   Status: MEETING SCHEDULED (2/18)
...
```
...
- Post-meeting follow-up: [REQUIRED if positive]
...
Board seats: 1 for lead investor
Anti-dilution: Broad-based weighted average
Voting rights: Class A common + Class A preferred (standard)
```
...
4. Documents finalized: Day 7-10
5. Legal review + signatures: Day 10-12
6. Funds wire: Day 12-14

**Total closing time**: ~2 weeks from term sheet to funded

---

## FINANCIAL TARGETS FOR INVESTORS

### Show Month 1 Actuals (Feb 2026):
...
Pro LTV:CAC: 15.8x (excellent)
Growth rate: Week-on-week 40%+
```

### Uses of proceeds ($1.5M):

```
Sales & Business Development: $600K (40%)
  → 5 enterprise AEs
...
Marketing & Growth: $300K (20%)
  → Marketing manager
  → Paid acquisition ($50K/month budget)
  → Brand/PR agency

Operations & Admin: $150K (10%)
  → Finance manager
  → Legal/formation
  → Infrastructure/tools
```

### Path to $121M+ ARR (Month 6):

```
Month 1: $8.2M ARR
Month 2: $22.7M ARR (+177%)
Month 3: $42.75M ARR (+88%)
Month 4: $76M ARR (+78% slower growth as market saturates)
Month 5: $105M ARR (+38%)
Month 6: $143.6M ARR (+37%)

Assumption: Free→Pro conversion stays 30%
Assumption: Pro→Enterprise 15%
Assumption: Marketplace revenue grows to $7.5M MRR by Month 6
```
...
1. **Hiring** (Week 1-2):
   ...
   - 3 engineers
   - 1 marketplace partnerships manager
   - 1 marketing manager

2. **Infrastructure** (Week 1-2):
   - Onboard investors to Slack channel
   - Monthly board meeting scheduled (1st meeting post-close)
   - Financial reporting set up (monthly P&L, KPI dashboard)
   - Investor data room live (ongoing updates)

3. **Product** (Month 1-2):
   - White-label platform launched (Enterprise tier)
   - Marketplace partner program live (5+ partners)
   - Metered billing fully operational

4. **Metrics** (Month 1+):
   - Daily KPI updates to investors (email digest)
   - Monthly board materials
   - Quarterly business reviews (Q1 end is Month 3)

---

## 🚀 IMMEDIATE ACTION PLAN: GET GOOGLE'S ATTENTION
...
Benefits:
  ...
  - Direct intro to GV partners
  - Feature in Google case studies
  - Access to Google's technical experts
...
Benefits:
  - Feature in Google Cloud marketing
  - Intro to CapitalG/GV through Cloud sales
  - Technical support for scaling
...
Angle: "Freight routing optimization using Maps API"
Outcome: Potential intro to GV through product team
```
...
Publish on Medium/LinkedIn:
  ...
  - "Genesis AI: Using Google's ML Infrastructure for Logistics"
  - "Scaling to $8.2M ARR on GCP - A Technical Journey"

Tag: @GoogleCloud, @GVTeam, mention GV portfolio companies
Goal: Get Google's attention organically
```
...
If we hit Top 3-5 on Product Hunt:
  ...
  - Press release: Mention Google Cloud infrastructure
  - Twitter: Tag @GoogleCloud, @GVTeam with metrics
```
...
Subject: INFÆMOUS FREIGHT - AI-first freight OS (Convoy meets ChatGPT)
Body: [Use EMAIL TEMPLATE 1B above]
...
Hook: "Fastest-growing logistics SaaS you'll see this quarter"
```
...
- Ask Google Cloud team for VC intros
- Leverage their startup ecosystem team
```
...
If GV passes, target:
  ...
  - Alphabet's other funds (if applicable)
  - VCs who co-invest with GV frequently
```
...
- Use GV's portfolio companies as customers
- Return to GV with even stronger metrics
```

---

## 📊 GOOGLE PITCH DECK (11th Slide - Google-Specific)

**IF pitching to GV/CapitalG, add this slide:**

### **Slide 11: Google Ecosystem Synergies**
...
- **Google AI/ML**: Leverage Vertex AI for autonomous operations
...
- Entry point to $900B freight market for Google products

**Ask**: GV/CapitalG lead with strategic partnership (beyond just capital)

---

## 💼 GOOGLE-SPECIFIC DUE DILIGENCE PREP
...
4. Integration marketplace with Google products
5. PR/marketing around Google partnership

---

## 🎯 SUCCESS METRICS (Google-Specific)

**Week 1 Goal**: Google for Startups application submitted  
...
**Good luck. We're going to raise this fund. Let's go 🚀**
