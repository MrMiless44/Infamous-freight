    ...
    freightServices: {
        ...
        'domestic-ground': {
            ...
            weightBasedPricing: {
                ...
                unit: 'kg',
                rates: [
                    { weight: [0, 10], pricePerUnit: 0.50 },
                    { weight: [10, 50], pricePerUnit: 0.40 },
                    { weight: [50, 100], pricePerUnit: 0.35 },
                    { weight: [100, 500], pricePerUnit: 0.30 },
                    { weight: [500, 1000], pricePerUnit: 0.25 },
                    { weight: [1000, 5000], pricePerUnit: 0.20 },
                ],
                minCharge: 2.50,
            },
        ...
        'international-shipping': {
            ...
            weightBasedPricing: {
                ...
                unit: 'kg',
                rates: [
                    { weight: [0, 10], pricePerUnit: 1.50 },
                    { weight: [10, 50], pricePerUnit: 1.20 },
                    { weight: [50, 100], pricePerUnit: 1.00 },
                    { weight: [100, 500], pricePerUnit: 0.80 },
                    { weight: [500, 1000], pricePerUnit: 0.60 },
                ],
                minCharge: 50.00,
            },
            estimatedDays: 10,
